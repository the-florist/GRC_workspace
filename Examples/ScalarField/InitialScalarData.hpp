...
class InitialScalarData
{
  public:
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        current_cell.store_vars(1. + m_h[r][0], c_h11);
        current_cell.store_vars(m_h[r][1], c_h12);
        current_cell.store_vars(m_h[r][2], c_h13);
        current_cell.store_vars(1. + m_h[r][3], c_h22);
